...
#include "PosterClass.h"

// Sets default values
APosterClass::APosterClass()
{
...
UTexture2D* APosterClass::LoadTextureFromPath(const FString& FilePath)
{
...
// Called every frame
void APosterClass::Tick(float DeltaTime)
{
